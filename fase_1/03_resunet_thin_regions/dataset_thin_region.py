...
def create_datasets(img_dir, label_dir, crop_size=(256,256), train_val_split=0.1, seed=None):
    ...
    # Set transformations
    train_transform = partial(create_transform, size_smaller=720, size_larger=2*720, mean=(mean_data, mean_data, mean_data), std=(std_data, std_data, std_data))
    valid_transform = partial(create_transform, size_smaller=720, size_larger=2*720, mean=(mean_data, mean_data, mean_data), std=(std_data, std_data, std_data))
